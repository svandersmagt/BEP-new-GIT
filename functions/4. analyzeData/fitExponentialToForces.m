...
%%
    ...
    smallDisplacements = bead.L./bead.extensionDNA > 0.95;
...
%     cornerFreqHighEnoughShort = bead.cornerFreqShort > 0.02;
    ...
    if plotThings;
        ...
        semilogy(zmags(not(smallDisplacements)),bead(1).forceLong(not(smallDisplacements)),'bx','linewidth', 2, 'markersize', 10);
        semilogy(zmags(not(smallDisplacements)),bead(1).forceShort(not(smallDisplacements)),'rx','linewidth', 2, 'markersize', 10);
